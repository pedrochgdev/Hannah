...
BOOK_IDS = [
    ...
    (28945, "Rafael Sabatini",    "Scaramouche: A Romance of the French Revolution"), 
    ...
    (49620, "D.H. Lawrence",      "Women in Love"),                 
    ...
    (5740,  "Marie de France",    "French Mediaeval Romances from the Lays of Marie de France"), 
